...
class RecipientAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Системная информация', {
            'fields': ('created_at', 'updated_at', 'mailings_count_display'),
            'classes': ('collapse',)
        }),
    )
...
class MailingAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'message_subject', 'status_display', 'start_time', 'end_time', 
    ...
    fieldsets = (
        ('Основные параметры', {
            'fields': ('message', 'recipients', 'status_display')
        }),
        ('Временные настройки', {
            'fields': ('start_time', 'end_time')
        }),
        ('Информация о рассылке', {
            'fields': ('created_at', 'updated_at', 'recipients_list'),
            'classes': ('collapse',)
        }),
    )
