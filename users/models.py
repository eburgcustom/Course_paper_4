...
class CustomUser(AbstractUser):
    ...
    role = models.CharField(
        _("Роль"), max_length=20, choices=ROLE_CHOICES, default=ROLE_USER, help_text=_("Роль пользователя в системе")
    )
    is_active = models.BooleanField(
        _("Активен"), default=True, help_text=_("Указывает, может ли пользователь входить в систему")
    )
